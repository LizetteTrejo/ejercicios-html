...
changeElementById("textoh2", "Why are you so obsessed with me?");
...
/**
 * Modificar un elemento usando el selector universal
 */
...
const displayNone = () => {
  const element = document.querySelector("#textoh2");

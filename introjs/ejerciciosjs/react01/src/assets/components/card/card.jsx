  ...
  return (
    ...
    sx={{
      ...
      <Typography variant="h6" component={"p"}>
        Piezas: <Typography variant="h6" component={"span"}>{counter}</Typography>
      </Typography>

      <Typography variant="h6" component={"p"}>
        Número máx de piezas: <Typography variant="h6" component={"p"}>{stock}</Typography>
      </Typography>

      <Button disabled = { counter<= 0 } variant="contained" onClick={handleDecrement}
        sx={{
          mx: 1,
          borderRadius: 2,
          "&:hover": {
      ...
      <Button disabled = { counter>= stock }variant="contained" onClick={handleIncrement}
        sx={{
          mx: 1,
          borderRadius: 2,
          "&:hover": {
